...
export default function Relaxation() {
    ...
    const [relaxations] = useState([
        ...
        { id: 3, videoId: "YWW1Kc7j6Do", message: 'You are allowed to rest, to take a pause, and to simply be. Embrace this time to relax and recharge.', suggestedUser: "Lin Lin" },
